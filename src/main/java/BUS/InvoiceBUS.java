...
// Dùng để: Hiển thị danh sách tất cả các hóa đơn trong hệ thống (quản lý, thống kê...).
    ...
    //Lấy danh sách hóa đơn theo loại (IMPORT / EXPORT).
    // Ví dụ: Lấy hóa đơn nhập hàng hoặc hóa đơn bán hàng.
